...
pub trait Recognizer {
    ...
    fn sempred(&self, _local_ctx: Rc<dyn RuleContext>, _rule_idx: isize, _action_idx: isize) -> bool { true }

    fn precpred(&self, _local_ctx: Rc<dyn RuleContext>, _precedence: isize) -> bool { true }
