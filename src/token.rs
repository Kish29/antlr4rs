...
use crate::tokensrc::TokenSource;
...
pub trait Token {
    ...
    fn channel() -> isize { TOKEN_DEFAULT_CHANNEL }
     ...
     */
    fn token_source() -> Option<Rc<dyn TokenSource>>;

    /**
     * Gets the {@link CharStream} from which this token was derived.
     */
    fn input_stream() -> Option<Rc<dyn CharStream>>;
}